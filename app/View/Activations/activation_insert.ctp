...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Admins'), array('controller' => 'administrators', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Admin'), array('controller' => 'administrators', 'action' => 'add')); ?> </li>
