...
<div class="related">
	...
	<?php foreach ($activation['Administrator'] as $administrator): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'administrators', 'action' => 'admin_view', $administrator['id'])); ?>
...
<div class="related">
	...
	<?php foreach ($activation['Insert'] as $insert): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'inserts', 'action' => 'admin_view', $insert['id'])); ?>
...
<div class="related">
	...
	<?php foreach ($activation['Structure'] as $structure): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'structures', 'action' => 'admin_view', $structure['id'])); ?>
