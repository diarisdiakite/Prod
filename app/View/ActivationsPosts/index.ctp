<div class="activationsPosts index">
	<h2><?php echo __('Activations Posts'); ?></h2>
	...
	<tr>
		<td><?php echo h($activationsPost['ActivationsPost']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($activationsPost['ActivationsPost']['created']); ?>&nbsp;</td>
		<td><?php echo h($activationsPost['ActivationsPost']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $activationsPost['ActivationsPost']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $activationsPost['ActivationsPost']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $activationsPost['ActivationsPost']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $activationsPost['ActivationsPost']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
