...
<?php echo $this->Form->create('Assistant', array('class' => 'form')); ?>
	<fieldset>
		<legend><?php echo __('Modifier un Assistant'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Assistant.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Assistant.id')))); ?></li>
