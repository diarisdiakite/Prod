<div class="composants index">
	...
	<tr>
		...
		<td><?php echo h($composant['Composant']['title']); ?>&nbsp;</td>
		<td><?php echo h($composant['Composant']['description']); ?>&nbsp;</td>
		<td><?php echo h($composant['Composant']['created']); ?>&nbsp;</td>
		<td><?php echo h($composant['Composant']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'admin_view', $composant['Composant']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $composant['Composant']['id'])); ?>
