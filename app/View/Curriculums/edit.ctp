...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Curriculum.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Curriculum.id')))); ?></li>
		<li><?php echo $this->Html->link(__('List Cv'), array('action' => 'index')); ?></li>
	</ul>
<?php else: ?>
