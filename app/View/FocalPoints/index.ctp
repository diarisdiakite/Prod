<div class="focalPoints index">
	...
	<?php if(AuthComponent::user('group_id')==5): ?>
	<tr>
		<td><?php echo h($focalPoint['FocalPoint']['id']); ?>&nbsp;</td>
		<td><?php echo h($focalPoint['FocalPoint']['name']); ?>&nbsp;</td>
		<td><?php echo h($focalPoint['FocalPoint']['adress']); ?>&nbsp;</td>
		...
		-->
		<td>
			<?php echo h($focalPoint['User']['username']); ?>
		</td>
		<td>
	...
	-->
		...
		<?php if(AuthComponent::user('group_id')==5): ?>
			<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'admin_view', $focalPoint['FocalPoint']['id'])); ?>
