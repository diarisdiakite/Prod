...
<h2><?php echo __('Emploi-métier'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($jobEmployment['Leash']['title'], array('controller' => 'leashes', 'action' => 'admin_view', $jobEmployment['Leash']['id'])); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php foreach ($jobEmployment['Training'] as $training): ?>
		...
		<tr>
			...
			<td><?php echo $this->Html->link($paname['ProjectAction']['title'], array('controller' => 'project_actions', 'action' => 'admin_view', $training['project_action_id'])) ; ?></td>
			<td><?php echo $jobEmployment['JobEmployment']['title']; ?></td>
			<td><?php echo $training['title']; ?></td>
			<td><?php echo $this->Html->link($lname['Level']['title'], array('controller' => 'levels', 'action' => 'admin_view', $training['level_id'])) ; ?></td>
