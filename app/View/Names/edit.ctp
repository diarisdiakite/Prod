...
<?php echo $this->Form->create('Name', array('class' => 'form')); ?>
	<fieldset>
		<legend><?php echo __('Editer un Nom'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Name.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Name.id')))); ?></li>
