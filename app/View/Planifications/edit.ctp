...
<?php echo $this->Form->create('Planification', array('class' => 'form')); ?>
	<fieldset>
		<legend><?php echo __('Edit Planification'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Planification.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Planification.id')))); ?></li>
