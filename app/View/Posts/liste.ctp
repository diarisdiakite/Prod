...
<div class="menu">
                ...
                <div class="row">
                        ...
                        <div class="caption">
                                ...
                                ;
                                ?>
                                <?php echo $this->Html->link($post['Type']['name'], array('controller' => 'types', 'action' => 'view', $post['Type']['id'])); ?>
                                <br><?php echo $this->Html->link($post['Post']['title'], array('action' => 'view', $post['Post']['id'])); ?>
                                <!-- <br><?php echo h($post['Post']['body']); ?>&nbsp; -->
                                <br>Publié le : <?php echo h($post['Post']['created']); ?>&nbsp;
                                <br><?php echo $this->Html->link($post['User']['username'], array('controller' => 'users', 'action' => 'view', $post['User']['id'])); ?>
