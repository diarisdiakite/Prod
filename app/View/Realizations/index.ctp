<div class="realizations index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('beginning'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($realization['Realization']['beginning']); ?>&nbsp;</td>
		<td><?php echo h($realization['Realization']['duration']); ?>&nbsp;</td>
