...
<h2><?php echo __('Realization'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Training Id'); ?></dt>
		<dd>
			<?php echo h($realization['Realization']['training_id']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($realization['Realization']['description']); ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Beginning'); ?></dt>
		<dd>
			<?php echo h($realization['Realization']['beginning']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Duration'); ?></dt>
		<dd>
			<?php echo h($realization['Realization']['duration']); ?>
			&nbsp;
		</dd>
