...
<?php echo $this->Form->create('Sector', array('class' => 'form')); ?>
	<fieldset>
		<legend><?php echo __('Modifier un Secteur'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Sector.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Sector.id')))); ?></li>
