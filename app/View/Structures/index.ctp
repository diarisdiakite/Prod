<div class="structures index">
	...
	<tr>
		<td><?php echo h($structure['Structure']['id']); ?>&nbsp;</td>
		<td><?php echo h($structure['Structure']['user_id']); ?>&nbsp;</td>
		...
		<td><?php echo h($structure['Structure']['active']); ?>&nbsp;</td>
		<td><?php echo h($structure['Structure']['created']); ?>&nbsp;</td>
		<td><?php echo h($structure['Structure']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'admin_view', $structure['Structure']['id'])); ?>
