...
<div class="related">
	...
	<?php foreach ($user['Expert'] as $expert): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'experts', 'action' => 'admin_view', $expert['id'])); ?>
...
<div class="related">
	...
	<?php foreach ($user['FinancesResponsible'] as $financesResponsible): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'finances_responsibles', 'action' => 'admin_view', $financialResponsible['id'])); ?>
...
<div class="related">
	...
	<?php foreach ($user['FocalPoint'] as $focalPoint): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'focal_points', 'action' => 'admin_view', $focalPoint['id'])); ?>
...
<div class="related">
	...
	<?php foreach ($user['Post'] as $post): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'posts', 'action' => 'admin_view', $post['id'])); ?>
